                ...
                $http({
                    ...
                    .success(function(data) {
                        if (!data.success) {
                            ...
                            helpers.UI.showSnackbar({text: 'Error getting plugin list!', actionTextColor: '#B92929'});
                        }
                    ...
                    var html = '<tr style="background: #B92929 !important;"><td style="color: #fff;">Unable to load plugin list!</td><td></td><td></td><td></td></tr>';
                ...
                $http({
                    ...
                    .success(function(data) {
                        if (!data.success) {
                            ...
                            helpers.UI.showSnackbar({text: 'Error installing plugin!', actionTextColor: '#B92929'});
                        }

                        //Real Success
                        helpers.UI.showSnackbar({text: 'Installed Plugin. Restarting Server...'});
                ...
                $http({
                    ...
                    .success(function(data) {
                        if (!data.success) {
                            ...
                            helpers.UI.showSnackbar({text: 'Error removing plugin!', actionTextColor: '#B92929'});
                        }

                        //Real Success
                        helpers.UI.showSnackbar({text: 'Removed Plugin. Restarting Server...'});
                        $('#serverRestarting').removeClass('hide');
                        $timeout(function() {
                            $window.location.reload();
                        }, 5000);
