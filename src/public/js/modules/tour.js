...
define('modules/tour', [
    ...
    tour.addStep('welcome', {
        title: 'Welcome!',
        text: '<div class="logo" style="margin-left: 70px;">' +
    ...
    tour.addStep('message_list', {
        title: 'Message List',
        text: 'Here you will find your current active conversations. If there are no current conversation, you can start a conversation. We will view that next.',
    ...
    tour.addStep('all_user_list', {
        title: 'User List',
        text: 'Here you will find the same list as before, the all user list. Clicking on a user will start the conversation.',
